...
**请求方式：** POST <br>
**请求地址：** `/api/platform/member/res_upload`<br>
...
| id_face_md5                          | 是                                   | 字符串                               | 人像面照片文件的md5，全小写       |
| id_back_md5                          | 是                                   | 字符串                               | 身份证反面照片文件的md5，全小写   |
| contract_md5                         |                                      | 字符串                               | 合同文件md5，全小写               |
| face                                 | 是                                   | 文件 file                            | 身份证人像面照片，<3M，不参与签名 |
| back                                 | 是                                   | 文件 file                            | 身份证反面照片，<3M，不参与签名   |
| contract_file                        | 是                                   | 文件 file                            | 合同文件，仅一份，<3M，不参与签名 |
